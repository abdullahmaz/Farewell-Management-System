...
export default function Login() {
  ...
  return (
    <div className="bg-cover bg-center h-screen" style={{backgroundImage: `url('/login_bg.jpg')`}}>
      <div className="flex min-h-[100dvh] flex-col items-center justify-center py-12 dark:bg-gray-950" >
        <div className="mx-auto w-full max-w-md space-y-8">
          <div className="text-center">
            <PartyPopperIcon className="mx-auto h-12 w-12 text-white" />
            <h1
              className="mt-4 text-4xl font-bold tracking-tight text-white dark:text-gray-50">Welcome Back</h1>
            <p className="mt-2 text-sm text-white dark:text-gray-400">
              Don't have an account? 
              <Link
                className="font-medium text-white hover:underline dark:text-gray-50 px-1"
                to="/register">
                Register
              </Link>
            </p>
