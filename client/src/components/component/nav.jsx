...
import { HomeIcon, BellIcon, Package2Icon, UsersIcon, ClipboardIcon, DollarSignIcon, MailIcon} from "./icons"

export default function Nav({ user, setUser }) {
  return (
    <div className="hidden bg-amber-300 lg:block dark:bg-gray-800/40">
